 ...
 * 
 * GNU QSORT is free software; you can redistribute it and/or
...
/* Order size using quicksort.  This implementation incorporates
   ...
   1. Non-recursive, using an explicit stack of pointer that store the 
      ...
      sizeof (stack_node) == 256 bits.  Pretty cheap, actually.
...
int 
qsort (char *base_ptr, int total_elems, int size, int (*cmp)())
{
