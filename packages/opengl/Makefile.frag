OpenGL_FILES = \
packages/opengl/ChangeLog packages/opengl/OpenGLEnum.st packages/opengl/OpenGLObjects.st packages/opengl/OpenGL.st packages/opengl/OpenGLUEnum.st packages/opengl/OpenGLUNurbs.st packages/opengl/OpenGLU.st packages/opengl/OpenGLUTess.st packages/opengl/test/bezsurf.st packages/opengl/test/cubemap.st packages/opengl/test/font.st packages/opengl/test/list.st packages/opengl/test/robot.st packages/opengl/test/surface.st packages/opengl/test/surfpoints.st packages/opengl/test/tess.st packages/opengl/test/test2.st packages/opengl/test/test.st packages/opengl/test/texturesurf.st packages/opengl/test/unproject.st 
$(OpenGL_FILES):
