...
{
       0,   118,   118,   117,   126,   132,   131,   144,   149,   155,
     160,   166,   174,   179,   188,   191,   198,   197,   210,   214,
     219,   218
};
#endif
...
static const char *const yytname[] =
{
  ...
  "\"number\"", "\"identifier\"", "'['", "']'", "'('", "')'", "'{'", 
  "'}'", "','", "'='", "':'", "LITERAL", "WSPACE", "$accept", "input", 
  "@1", "primitive_decl", "@2", "primitive_decl_2", "primitive_number", 
...
#line 122 "genpr-parse.y"
  ...
  case 4:
#line 126 "genpr-parse.y"
    {
	  }
    break;

  case 5:
#line 132 "genpr-parse.y"
    {
	    current_id = 0;
	    current_func_name = strdup (yyvsp[0].text);
	    gen_proto (yyvsp[0].text);
	    gen_prim_decl (yyvsp[0].text);
	  }
    break;

  case 6:
#line 139 "genpr-parse.y"
    {
	  }
    break;
...
#line 145 "genpr-parse.y"
    {
	    gen_prim_id (current_func_name, yyvsp[-1].id, yyvsp[0].text);
	    free (yyvsp[0].text);
	  }
    break;

  case 8:
#line 150 "genpr-parse.y"
    {
	  }
    break;

  case 9:
#line 156 "genpr-parse.y"
    {
	    yyval.id = strtoul (yyvsp[0].text, NULL, 10);
	  }
    break;

  case 10:
#line 160 "genpr-parse.y"
    {
	    yyval.id = current_id--;
	  }
    break;
...
#line 167 "genpr-parse.y"
    {
	    yyval.text = fildelete (yyvsp[-1].fil);
	    strupr (yyval.text);
	  }
    break;

  case 12:
#line 175 "genpr-parse.y"
    {
	    yyval.fil = filnew ("PRIM_", 5);
	    filcat (yyval.fil, yyvsp[0].text);
	  }
    break;

  case 13:
#line 180 "genpr-parse.y"
    {
	    yyval.fil = yyvsp[-2].fil;
...
#line 202 "genpr-parse.y"
    {
	    gen_prim_id (yyvsp[-2].text, yyvsp[-1].id, yyvsp[0].text);
	    free (yyvsp[-2].text);
	    free (yyvsp[0].text);
	  }
    break;
...
#line 211 "genpr-parse.y"
    {
	    filprintf (stmt_fil, "%d", yyvsp[0].id);
	  }
    break;

  case 20:
#line 219 "genpr-parse.y"
    {
	    yyval.id = lookup_prim_id (yyvsp[0].text);
