...
static const char standard_files[] = {
  "bootstrap/Behavior.st\0"
  "bootstrap/Object.st\0"
  "bootstrap/Dictionary.st\0"
  "bootstrap/Class.st\0"
  "bootstrap/ClassDescription.st\0"
  "bootstrap/UndefinedObject.st\0"
  "SystemDictionary.st\0"
  "Object.st\0"
  "Message.st\0"
  "MessageLookup.st\0"
  "DirectedMessage.st\0"
  "Boolean.st\0"
  "False.st\0"
  "True.st\0"
  "Magnitude.st\0"
  "LookupKey.st\0"
  "DeferredVariableBinding.st\0"
  "Association.st\0"
  "HomedAssociation.st\0"
  "VariableBinding.st\0"
  "Integer.st\0"
  "Date.st\0"
  "Time.st\0"
  "Number.st\0"
  ...
  "Fraction.st\0"
  "LargeInteger.st\0"
  "LargeNegativeInteger.st\0"
  "LargePositiveInteger.st\0"
  "LargeZeroInteger.st\0"
  "SmallInteger.st\0"
  "Character.st\0"
  "UnicodeCharacter.st\0"
  "Link.st\0"
  "Process.st\0"
  "CallinProcess.st\0"
  "Iterable.st\0"
  "Collection.st\0"
  "SequenceableCollection.st\0"
  "LinkedList.st\0"
  "Semaphore.st\0"
  "ArrayedCollection.st\0"
  "CompiledCode.st\0"
  "CompiledMethod.st\0"
  "CompiledBlock.st\0"
  "Array.st\0"
  ...
  "UnicodeString.st\0"
  "Interval.st\0"
  "OrderedCollection.st\0"
  "SortedCollection.st\0"
  "HashedCollection.st\0"
  "Set.st\0"
  "IdentitySet.st\0"
  "Dictionary.st\0"
  "LookupTable.st\0"
  "IdentityDictionary.st\0"
  "MethodDictionary.st\0"
  "BindingDictionary.st\0"
  "AbstractNamespace.st\0"
  "RootNamespace.st\0"
  "Namespace.st\0"
  "Stream.st\0"
  "PositionableStream.st\0"
  "ReadStream.st\0"
  "WriteStream.st\0"
  "ReadWriteStream.st\0"
  "UndefinedObject.st\0"
  "ProcessorScheduler.st\0"
  "ContextPart.st\0"
  "MethodContext.st\0"
  "BlockContext.st\0"
  "BlockClosure.st\0"
  "Behavior.st\0"
  "ClassDescription.st\0"
  "Class.st\0"
  "Metaclass.st\0"
  "Continuation.st\0"
  "Memory.st\0"
  ...
  "SymLink.st\0"
  "Security.st\0"
  "collection/weak/WeakArray.st\0"
  "collection/weak/WeakSet.st\0"
  "collection/weak/WeakKeyDictionary.st\0"
  "collection/weak/WeakValueLookupTable.st\0"
  "collection/weak/WeakIdentitySet.st\0"
  "collection/weak/WeakKeyIdentityDictionary.st\0"
  "collection/weak/WeakValueIdentityDictionary.st\0"
  "ObjectMemory.st\0"

  /* More core classes */
  "Bag.st\0"
  "MappedCollection.st\0"
  "Delay.st\0"
  "SharedQueue.st\0"
  "Random.st\0"
  "RecursionLock.st\0"
  ...
  "Transcript.st\0"
  "Point.st\0"
  "PointExtensions.st\0"
  "Rectangle.st\0"
  "RectangleExtensions.st\0"
  "RunArray.st\0"
  "RunArrayExtensions.st\0"
  "DateTime.st\0"
  "Duration.st\0"
  "ScaledDecimal.st\0"
  "value-adaptor/ValueAdaptor.st\0"
  "value-adaptor/NullValueHolder.st\0"
  "value-adaptor/ValueHolder.st\0"
  "value-adaptor/ValueHolderExtensions.st\0"
  "value-adaptor/Promise.st\0"
  "value-adaptor/PluggableAdaptor.st\0"
  "value-adaptor/DelayedAdaptor.st\0"
  "WordArray.st\0"
  "LargeArraySubpart.st\0"
  "LargeArrayedCollection.st\0"
  "LargeArray.st\0"
  "LargeByteArray.st\0"
  "LargeWordArray.st\0"
  ...
  "ffi/CByte.st\0"
  "ffi/CBoolean.st\0"
  "ffi/CObjectExtensions.st\0"
  "ffi/CType.st\0"
  "ffi/CScalarCType.st\0"
  "ffi/CStringCType.st\0"
  "ffi/CPtrCType.st\0"
  "ffi/CArrayCType.st\0"
  "ffi/CTypeInitialization.st\0"
  "ffi/CCallable.st\0"
  "ffi/CFunctionDescriptor.st\0"
  "ffi/Extensions.st\0"
  "ffi/CCallbackDescriptor.st\0"
  "ffi/CCompound.st\0"
  "ffi/CStruct.st\0"
  "ffi/CUnion.st\0"

  /* Exception handling and ProcessEnvironment */
  "ProcessEnvironment.st\0"
  "ProcessVariable.st\0"
  "exceptions/ExceptionSet.st\0"
  "exceptions/Exception.st\0"
  "exceptions/Error.st\0"
  "exceptions/Notification.st\0"
  "exceptions/Warning.st\0"
  "exceptions/Halt.st\0"
  "exceptions/ArithmeticError.st\0"
  "exceptions/MessageNotUnderstood.st\0"
  "exceptions/ZeroDivide.st\0"
  "exceptions/ProcessBeingTerminated.st\0"
  "exceptions/EndOfStream.st\0"
  "exceptions/NotEnoughElements.st\0"
  "exceptions/InvalidValue.st\0"
  "exceptions/InvalidState.st\0"
  "exceptions/NotIndexable.st\0"
  "exceptions/ReadOnlyObject.st\0"
  "exceptions/EmptyCollection.st\0"
  "exceptions/InvalidArgument.st\0"
  "exceptions/AlreadyDefined.st\0"
  "exceptions/ArgumentOutOfRange.st\0"
  "exceptions/IndexOutOfRange.st\0"
  "exceptions/InvalidSize.st\0"
  "exceptions/NotFound.st\0"
  "exceptions/WrongClass.st\0"
  "exceptions/MustBeBoolean.st\0"
  "exceptions/ProcessTerminated.st\0"
  "exceptions/InvalidProcessState.st\0"
  "exceptions/MutationError.st\0"
  "exceptions/VMError.st\0"
  "exceptions/VerificationError.st\0"
  "exceptions/BadReturn.st\0"
  "exceptions/UserInterrupt.st\0"
  "exceptions/NoRunnableProcess.st\0"
  "exceptions/PrimitiveFailed.st\0"
  "exceptions/WrongArgumentCount.st\0"
  "exceptions/CInterfaceError.st\0"
  "exceptions/FileError.st\0"
  "exceptions/NotImplemented.st\0"
  "exceptions/NotYetImplemented.st\0"
  "exceptions/ShouldNotImplement.st\0"
  "exceptions/WrongMessageSent.st\0"
  "exceptions/SubclassResponsibility.st\0"
  "exceptions/UnhandledException.st\0"
  "exceptions/TimeoutNotification.st\0"
  "exceptions/Extensions.st\0"
  "exceptions/Initialization.st\0"

  /* Virtual filesystem layer */
  "FilePath.st\0"
  "file/Extensions.st\0"
  "file/Stat.st\0"
  "file/File.st\0"
  "Directory.st\0"
  "file/vfs/FileWrapper.st\0"
  "file/vfs/RecursiveFileWrapper.st\0"
  "file/vfs/ArchiveFile.st\0"
  "file/vfs/ArchiveMember.st\0"
  "file/vfs/TmpFileArchiveMember.st\0"
  "file/vfs/ZipFile.st\0"
  "file/vfs/StoredZipMember.st\0"
  "file/vfs/LimitedStream.st\0"
  "file/vfs/Extensions.st\0"
  "url/URL.st\0"
  "url/URIResolver.st\0"
  "url/Initialization.st\0"
  "FileStream.st\0"

  /* Goodies */
  "DynamicVariable.st\0"
  "dld/Extensions.st\0"
  "dld/RoundRobinStream.st\0"
  "dld/DLD.st\0"
  "Getopt.st\0"
  "GetoptExtensions.st\0"
  "Generator.st\0"
  "stream/ConcatenatedStream.st\0"
  "stream/FilteringStream.st\0"
  "stream/CollectingStream.st\0"
  "stream/PeekableStream.st\0"
  "stream/LineStream.st\0"
  "stream/OneOfEachStream.st\0"
  "stream/Extensions.st\0"
  "regex/Regex.st\0"
  "regex/RegexResults.st\0"
  "regex/MatchingRegexResults.st\0"
  "regex/FailedMatchRegexResults.st\0"
  "regex/Extensions.st\0"
  "regex/Initialization.st\0"
  "package/PackageSkip.st\0"
  "package/PackageNotAvailable.st\0"
  "package/PackageGroup.st\0"
  "package/PackageDirectories.st\0"
  "package/PackageContainer.st\0"
  "package/PackageDirectory.st\0"
  "package/PackageInfo.st\0"
  "package/StarPackage.st\0"
  "package/Package.st\0"
  "package/DisabledPackage.st\0"
  "package/TestPackage.st\0"
  "package/PackageLoader.st\0"
  "autoload/Extensions.st\0"
  "autoload/AutoloadClass.st\0"
  "autoload/Autoload.st\0"
};
