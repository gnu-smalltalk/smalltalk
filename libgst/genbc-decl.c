...
static const yytype_uint16 yyrline[] =
{
     ...
     160,   164,   172,   182,   182,   188,   189,   192,   195,   194,
     198,   200,   202,   207,   208,   211,   212,   217,   217,   224,
     225,   228,   229,   231,   234,   233,   254,   263,   264,   268,
     269,   273,   273,   286,   287,   291,   292,   296
};
#endif
...
#line 203 "genbc-decl.y"
  ...
  case 26:
#line 213 "genbc-decl.y"
    { filccat (curr_fil, ','); }
    break;

  case 27:
#line 217 "genbc-decl.y"
    { curr_fil = filnew (NULL, 0); }
    break;
...
#line 273 "genbc-decl.y"
  ...
  case 42:
#line 282 "genbc-decl.y"
    { filprintf (curr_fil, "; \\\n"); }
    break;

  case 43:
#line 286 "genbc-decl.y"
    { (yyval.num) = (yyvsp[(2) - (3)].num); }
    break;

  case 44:
#line 287 "genbc-decl.y"
    { (yyval.num) = 8; }
    break;

  case 45:
#line 291 "genbc-decl.y"
    { (yyval.num) = (yyvsp[(1) - (3)].num) + (yyvsp[(3) - (3)].num); }
    break;

  case 46:
#line 292 "genbc-decl.y"
    { (yyval.num) = (yyvsp[(1) - (1)].num); }
    break;

  case 47:
#line 297 "genbc-decl.y"
    { define_field ((yyvsp[(1) - (2)].text), (yyvsp[(2) - (2)].num)); (yyval.num) = (yyvsp[(2) - (2)].num); }
    break;


/* Line 1267 of yacc.c.  */
#line 1648 "../../libgst/genbc-decl.c"
      default: break;
    }
